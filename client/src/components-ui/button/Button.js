...
// *************************** BUTTON COMPONENT *************************** //
const Button = ({ account, accountInfo, invert, social, profileRed, profileGrey, navbar, newsletter, item, product, checkout, editProduct, createProduct, children, onClick, ...otherProps }) => {
  return (
    <button 
      className={`
