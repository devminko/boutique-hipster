...
// *************************** BUTTON COMPONENT *************************** //
const Button = ({ account, accountInfo, invert, social, profileRed, profileGrey, navbar, newsletter, item, product, checkout, editProduct, createProduct, aboutPage, children, onClick, ...otherProps }) => {
  return (
    <button 
      className={`
